...
public class Activator extends ComponentActivatorAbstractBase {
	...
	public void configureInstance(Component c, Object imp, String containerName) {
		...
		if (imp.equals(PacketHandler.class)) {
			...
			c.setInterface(
					new String[] { IListenDataPacket.class.getName() },
							props);
			...
			c.add(createContainerServiceDependency(containerName)
					...
					.setCallbacks("setStatisticsManagerService",
							"unsetStatisticsManagerService").setRequired(true));

			// Need a TopologyManagerService to try to obtain map with the
			// topology
			c.add(createContainerServiceDependency(containerName)
